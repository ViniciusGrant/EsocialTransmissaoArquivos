...
namespace E_Social.ServiceReference1 {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.esocial.gov.br/servicos/empregador/lote/eventos/envio/v1_1_0", ConfigurationName="ServiceReference1.ServicoEnviarLoteEventos")]
    public interface ServicoEnviarLoteEventos {
        ...
        E_Social.ServiceReference1.EnviarLoteEventosResponse EnviarLoteEventos(E_Social.ServiceReference1.EnviarLoteEventosRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.esocial.gov.br/servicos/empregador/lote/eventos/envio/v1_1_0/ServicoEn" +
            "viarLoteEventos/EnviarLoteEventos", ReplyAction="http://www.esocial.gov.br/servicos/empregador/lote/eventos/envio/v1_1_0/ServicoEn" +
            "viarLoteEventos/EnviarLoteEventosResponse")]
        System.Threading.Tasks.Task<E_Social.ServiceReference1.EnviarLoteEventosResponse> EnviarLoteEventosAsync(E_Social.ServiceReference1.EnviarLoteEventosRequest request);
    }
    ...
    public partial class EnviarLoteEventosRequest {
        ...
        public E_Social.ServiceReference1.EnviarLoteEventosRequestBody Body;
        
        public EnviarLoteEventosRequest() {
        }
        
        public EnviarLoteEventosRequest(E_Social.ServiceReference1.EnviarLoteEventosRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class EnviarLoteEventosResponse {
        ...
        public E_Social.ServiceReference1.EnviarLoteEventosResponseBody Body;
        
        public EnviarLoteEventosResponse() {
        }
        
        public EnviarLoteEventosResponse(E_Social.ServiceReference1.EnviarLoteEventosResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ServicoEnviarLoteEventosChannel : E_Social.ServiceReference1.ServicoEnviarLoteEventos, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicoEnviarLoteEventosClient : System.ServiceModel.ClientBase<E_Social.ServiceReference1.ServicoEnviarLoteEventos>, E_Social.ServiceReference1.ServicoEnviarLoteEventos {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        E_Social.ServiceReference1.EnviarLoteEventosResponse E_Social.ServiceReference1.ServicoEnviarLoteEventos.EnviarLoteEventos(E_Social.ServiceReference1.EnviarLoteEventosRequest request) {
        ...
        public System.Xml.Linq.XElement EnviarLoteEventos(System.Xml.Linq.XElement loteEventos) {
            E_Social.ServiceReference1.EnviarLoteEventosRequest inValue = new E_Social.ServiceReference1.EnviarLoteEventosRequest();
            inValue.Body = new E_Social.ServiceReference1.EnviarLoteEventosRequestBody();
            inValue.Body.loteEventos = loteEventos;
            E_Social.ServiceReference1.EnviarLoteEventosResponse retVal = ((E_Social.ServiceReference1.ServicoEnviarLoteEventos)(this)).EnviarLoteEventos(inValue);
            return retVal.Body.EnviarLoteEventosResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<E_Social.ServiceReference1.EnviarLoteEventosResponse> E_Social.ServiceReference1.ServicoEnviarLoteEventos.EnviarLoteEventosAsync(E_Social.ServiceReference1.EnviarLoteEventosRequest request) {
            return base.Channel.EnviarLoteEventosAsync(request);
        }
        
        public System.Threading.Tasks.Task<E_Social.ServiceReference1.EnviarLoteEventosResponse> EnviarLoteEventosAsync(System.Xml.Linq.XElement loteEventos) {
            E_Social.ServiceReference1.EnviarLoteEventosRequest inValue = new E_Social.ServiceReference1.EnviarLoteEventosRequest();
            inValue.Body = new E_Social.ServiceReference1.EnviarLoteEventosRequestBody();
            inValue.Body.loteEventos = loteEventos;
            return ((E_Social.ServiceReference1.ServicoEnviarLoteEventos)(this)).EnviarLoteEventosAsync(inValue);
        }
    }
}
